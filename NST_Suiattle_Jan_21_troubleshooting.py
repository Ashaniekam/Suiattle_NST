<<<<<<< Updated upstream
=======
<<<<<<<< Updated upstream:NST_Suiattle_new_Jan_9.py
>>>>>>> Stashed changes
# -*- coding: utf-8 -*-
"""
...
# bookkeeping 
new_dir_name = "Testing for nans" + model_state ## Use when testing
#new_dir_name = "Longer_Run_Test_Scenario_1" + model_state
...
# # fig =plot_network_and_parcels(grid,parcels,parcel_time_index=0, link_attribute=('change_D'),parcel_alpha=0, link_attribute_title="Diameter [m]", network_cmap= "coolwarm")
>>>>>>>> Stashed changes:NST_Suiattle_Jan_21_troubleshooting.py
>>>>>>> Stashed changes
